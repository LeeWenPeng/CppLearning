...
![[../C++STL/容器/vector容器#2 定义和初始化#1 概念]]

### 3.2  向 vector 对象中添加元素

![[../C++STL/容器/vector容器#3 向 vector 对象中添加元素]]
